...
public final class UserController extends BaseController {
    ...
    public User createUsersWithListInput(
            final List<User> body) throws ApiException, IOException, JAXBException {
    ...
    public User getUserByName(
            final String username) throws ApiException, IOException, JAXBException {
    ...
    /**
     * This can only be done by the logged in user.
     * @param  username2  Required parameter: name that need to be deleted
     * @param  id  Optional parameter: Example:
     * @param  username  Optional parameter: Example:
     * @param  firstName  Optional parameter: Example:
     * @param  lastName  Optional parameter: Example:
    ...
    public void updateUser(
            ...
            final String phone,
            final Integer userStatus) throws ApiException, IOException {
        prepareUpdateUserRequest(username2, id, username, firstName, lastName, email, password,
                phone, userStatus).execute();
    }
    ...
    public CompletableFuture<Void> updateUserAsync(
            ...
            final Integer userStatus) {
        try { 
            return prepareUpdateUserRequest(username2, id, username, firstName, lastName, email, password,
    ...
    private ApiCall<Void, ApiException> prepareUpdateUserRequest(
        ...
        return new ApiCall.Builder<Void, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .formParam(param -> param.key("userStatus")
                                .value(userStatus).isRequired(false))
                        .templateParam(param -> param.key("username2").value(username2)
                                .shouldEncode(true))
                        .templateParam(param -> param.key("username").value(username).isRequired(false)
                                .shouldEncode(true))
                        .headerParam(param -> param.key("Content-Type")
                                .value("application/x-www-form-urlencoded").isRequired(false))
